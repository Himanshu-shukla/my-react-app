...
const HomeTable = ({ data, isSinceListing }) => {
      ...
      <Table>
        <TableHead>
          <TableRow>
            ...
            {isSinceListing && <TableCell>Since Listing</TableCell>}
        ...
        <TableBody>
          {data.map((item, index) => (
            <TableRow key={index}>
              ...
              {isSinceListing && (<TableCell>
                <ModifiedChip item={item.sinceListing} />
              </TableCell>)}
              {/* 4th Column */}
...
function Home({ intialTab = 0 }) {
  ...
  const gainersData = [
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '+45', volume: "$24,567,990.09", imageUrl: highGraph },
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '00', volume: "$24,567,990.09", imageUrl: highGraph },
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '+45', volume: "$24,567,990.09", imageUrl: highGraph },
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '+45', volume: "$24,567,990.09", imageUrl: highGraph },
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '+45', volume: "$24,567,990.09", imageUrl: highGraph },
  ];
  ...
  const losersData = [
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '-45', volume: "$24,567,990.09", imageUrl: lowGraph },
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '-45', volume: "$24,567,990.09", imageUrl: lowGraph },
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '-45', volume: "$24,567,990.09", imageUrl: lowGraph },
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '-45', volume: "$24,567,990.09", imageUrl: lowGraph },
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '-45', volume: "$24,567,990.09", imageUrl: lowGraph },
  ...
  const newListingData = [
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '+45', sinceListing: '+1200', volume: "$24,567,990.09", imageUrl: highGraph },
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '+45', sinceListing: '+1200', volume: "$24,567,990.09", imageUrl: highGraph },
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '+45', sinceListing: '+1200', volume: "$24,567,990.09", imageUrl: highGraph },
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '+45', sinceListing: '+1200', volume: "$24,567,990.09", imageUrl: highGraph },
    { name: 'PROPC', helperText: 'Propchain', price: '$2.03', change: '+45', sinceListing: '+1200', volume: "$24,567,990.09", imageUrl: highGraph },
      ...
      <Stack direction="column" style={{ width: "100%" }}>
        ...
        <div>
          ...
          <TabPanel value={value} index={0}>
            <HomeTable data={gainersData}></HomeTable>

          </TabPanel>
          <TabPanel value={value} index={1}>
            <HomeTable data={losersData}></HomeTable>
          </TabPanel>
