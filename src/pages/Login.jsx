...
const Login = () => {
  return (
    <div className="font-inter inline-flex h-[1024px] w-[1440px] resize flex-col items-center gap-y-1 overflow-hidden border border-solid border-gray-300 bg-white px-8 pb-44 pt-8" >
      <div className="flex h-10 items-start justify-between  self-stretch text-center text-sm font-semibold leading-normal tracking-[0px] text-slate-500" >
      ...
      <div className="flex h-20 w-22 items-end justify-center text-center text-[28px] font-semibold leading-tight tracking-[-0.32px] text-gray-900" >
      ...
      <div className="flex h-10 w-96 items-end justify-center pt-5 text-sm font-medium leading-normal tracking-[0px]" style={{ width: '25rem' }} >
        <div className="flex h-5 flex-grow items-center justify-center " >
          <div className="flex-shrink-0 h-5 w-5">
            <input type="checkbox" className="h-5 w-5 rounded border-[1.5px] border-solid border-gray-300 bg-white" />
          </div>
          <div className="ml-2 text-left text-gray-900" style={{ width: '13rem' }}>
            Remember me for 30 days
          </div>
          <div className="w-48 flex flex-grow items-center justify-end self-stretch  text-right text-slate-700" >
