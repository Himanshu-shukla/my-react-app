...
import { IconButton, InputBase, Drawer, List, ListItem, ListItemText } from '@mui/material';
...
const NavigationBar = () => {
  ...
  return (
    <nav >
      ...
      {/* Mobile view */}
      <div className={`mobile-view ${isMobileMenuOpen ? 'open' : ''}`}>
            ...
            <List>
              <ListItem >
                ...
                <div className="search-mobile">
                  ...
                  <input type="text" className="mobile-searchBar" placeholder="Search..." />
                </div>
              </ListItem>
              {/* ... (mobile menu items) */}
              <ListItem component={Link} to="/">
                ...
                <ListItemText style={{ color: "#2E3A5C", marginLeft: "12px" }} primary="Home" />
              </ListItem>
              <ListItem component={Link} to="/market">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <ListItemText primary="Market" style={{ color: "#2E3A5C", marginLeft: "12px" }} />
              </ListItem>
              <ListItem component={Link} to="/trade">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <ListItemText primary="Trade" style={{ color: "#2E3A5C", marginLeft: "12px" }} />
              </ListItem>
              <ListItem component={Link} to="/assets">
                ...
                <ListItemText primary="Assets" style={{ color: "#2E3A5C", marginLeft: "12px" }} />
              </ListItem>
              <ListItem component={Link} to="/faqs">
                ...
                <ListItemText primary="FAQs" style={{ color: "#2E3A5C", marginLeft: "12px" }} />
              </ListItem>
              <ListItem component={Link} to="/customer-support">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <ListItemText primary="Customer Support" style={{ color: "#2E3A5C", marginLeft: "12px" }} />
              </ListItem>
              <ListItem component={Link} to="/juna-blog">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M5.0003 17.5001L7.5003 2.50008M12.5003 17.5001L15.0003 2.50007M3.33363 6.66674L17.5003 6.66674M2.50027 13.3334L16.6669 13.3334" stroke="#101928" stroke-width="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>

                <ListItemText primary="Juna Blog" style={{ color: "#2E3A5C", marginLeft: "12px" }} />
              </ListItem>
              <ListItem component={Link} to="/delist-asset-token">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M5.0003 17.5001L7.5003 2.50008M12.5003 17.5001L15.0003 2.50007M3.33363 6.66674L17.5003 6.66674M2.50027 13.3334L16.6669 13.3334" stroke="#101928" stroke-width="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>

                <ListItemText primary="Delist Asset Tokenisation" style={{ color: "#2E3A5C", marginLeft: "12px" }} />
              </ListItem>
              <ListItem component={Link} to="/ico-page-ongoing">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M5.0003 17.5001L7.5003 2.50008M12.5003 17.5001L15.0003 2.50007M3.33363 6.66674L17.5003 6.66674M2.50027 13.3334L16.6669 13.3334" stroke="#101928" stroke-width="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              ...
              <ListItem component={Link} to="/stake-earn">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M5.0003 17.5001L7.5003 2.50008M12.5003 17.5001L15.0003 2.50007M3.33363 6.66674L17.5003 6.66674M2.50027 13.3334L16.6669 13.3334" stroke="#101928" stroke-width="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              ...
              <ListItem component={Link} to="/signup">
                ...
                <ListItemText primary="Log Out" style={{ color: "#2E3A5C", marginLeft: "12px" }} />
              </ListItem>
            </List>
          </div>
        </Drawer>
          ...
          <div className="Sidebar-section">
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              ...
              <li>
                ...
                <span style={{
                  backgroundColor: '#F0F2F5', // Replace with your desired badge color
                  color: '#344054',
                  padding: '4px 8px',
                  borderRadius: '50%',
                  marginLeft: '5px',
              ...
              <li>
                ...
                <Link to="/delist-asset-token" style={{
                  textDecoration: 'none',
                  color: 'var(--Primary, #2E3A5C)',
                  fontFamily: 'Inter',
                  fontSize: '14px',
                  ...
                  marginLeft: '5px',
                  flex: '1 0 0',
                }}>Delist Asset Tokenisation </Link>
              </li>
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M5.0003 17.5001L7.5003 2.50008M12.5003 17.5001L15.0003 2.50007M3.33363 6.66674L17.5003 6.66674M2.50027 13.3334L16.6669 13.3334" stroke="#101928" stroke-width="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
                <Link to="/ico-page-ongoing" style={{
                  textDecoration: 'none',
                  color: 'var(--Primary, #2E3A5C)',
                  fontFamily: 'Inter',
                  fontSize: '14px',
